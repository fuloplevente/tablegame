...
public class SQLResults
{
	...
	/**
	 * GetObject returns an object in the ArrayList results given a row and columnName
	 * @param row
	 * @param col
	 * @return object
	 */
	...
	/**
	 * Sets the value at given (row,col)
	 * @param row
	 * @param col
	 * @param o
	 */
  ...
  /**
   * Sets the value at given (row,columnName)
   * @param row
   * @param col
   * @param o
   */
  public void setObject(int row, String columnName, Object o)
  {
    int col = getColumnIndex(columnName);
    int index = (row * columnCount) + col;
    results.set(index, o);
  ...
  /**
   * Gets the byte[] array of the Blob field corresponding to row, columnName. If the value
   * is null, this method returns null.
   * @param row
   * @param columnName
   * @return byte[] 
   */
  public byte[] getBlobBytes(int row, String columnName)
  {
    return(getBlobBytes(row, getColumnIndex(columnName)));
  }

  /**
   * Gets the byte[] array of the field corresponding to row, col (a Blob). If the value
   * is null, this method returns null.
   * @param row
   * @param columnName
   * @return byte[] 
   */
  public byte[] getBlobBytes(int row, int col)
  {
    if (isNull(row, col))
      return(null);
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as an int. If the value
	...
	/**
	 * Gets the value of the field corresponding to (row, col) index as an int. If the value
	 * is null, this method returns 0.
	 * @param row
	 * @param col
	 * @return int value of field
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a long. If the value
	 * is null, this method returns 0.
	 * @param row int
	...
	/**
	 * Gets the value of the field corresponding to row, col as a long. If the value
	 * is null, this method returns 0.
	 * @param row
	 * @param col
	 * @return long
	 ...
	 * If the native SQL type is BigDecimal, Integer, Boolean, Date, Timestamp, Time, Float, or Double, this
	 * method converts that native type to String automatically. If the field is NULL, then it returns an
	 * empty string.
	 * @param row int
	 * @param col int
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a boolean. If the
	 * value is null, method returns false.
	 * @param row int
	 * @param col int
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a boolean. If the
	 * value is null, method returns false.
	 * @param row int
	 * @param columnName String
	 * @return boolean value of field
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a java.sql.Date. Handles
	 * either a Date or a Timestamp. If the value is null, it returns null.
	 * @param row int
	 * @param col int
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a java.sql.Date. Handles
	 * either a Date or a Timestamp. If the value is null, it returns null.
	 * @param row int
	 * @param columnName String
	 * @return Date value of field
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a java.sql.Time. Returns
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a java.sql.Time. Returns
	 * null if the value is null.
	 * @param row int
	 * @param columnName String
	 * @return Time value of field
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a java.sql.Timestamp. Handles
	 * either a Date or a Timestamp. If the value is null, it returns null.
	 * @param row int
	 * @param col int
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a java.sql.Timestamp. Handles
	 * either a Date or a Timestamp. If the value is null, it returns null.
	 * @param row int
	 * @param columnName String
	 * @return Timestamp value of field
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a double. Handles either a double or BigDecimal.
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a double. Handles either a double or BigDecimal.
	 * Returns 0 if value is null.
	 * @param row int
	 * @param columnName String
	 * @return double value of field
	...
	/**
	 * Gets the value of the field corresponding to (row, col) as a float. Handles either a float or BigDecimal.
	 * Returns 0 if value is null.
	 * @param row int
	 * @param col int
	...
	/**
	 * Gets the value of the field corresponding to row, columnName as a float. Handles either a float or BigDecimal.
	 * Returns 0 if value is null.
	 * @param row int
	 * @param columnName String
	 * @return float value of field
