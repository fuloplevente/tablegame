...
public class SQLExecutor
{
  ...
  /**
   * If param==true, adds "Y" to sqlExec object, "N" on false
   * if null, it calls sqlExec.addNullParam(VARCHAR)
   * @param sqlExec
   * @param param
   */
  public void addParamOrNullParam(Boolean param)
  {
    if (param == null)
      addNullParam(java.sql.Types.VARCHAR);
    else
    {
      if (param == true)
        addParam("Y");
  ...
  /**
   * Adds the String param to sqlExec object if not null, calls sqlExec.addNullParam(VARCHAR) otherwise.
   * @param sqlExec
   * @param param
   */
  public void addParamOrNullParam(String param)
  {
    if (param == null)
      addNullParam(java.sql.Types.VARCHAR);
    else
  ...
  /**
   * Adds the Integer param to sqlExec object if not null, calls sqlExec.addNullParam(INTEGER) otherwise.
   * @param sqlExec
   * @param param
   */
  public void addParamOrNullParam(Integer param)
  {
    if (param == null)
      addNullParam(java.sql.Types.INTEGER);
    else
      addParam(param.intValue());
  }

  /**
   * Adds the int param to sqlExec object if not null, calls sqlExec.addNullParam(INTEGER) otherwise.
   * @param sqlExec
   * @param param
   */
  public void addParamOrNullParam(int param)
  {
    if (param == -1)
      addNullParam(java.sql.Types.INTEGER);
    else
